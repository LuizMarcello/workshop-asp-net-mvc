...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            SalesRecord r5 = new SalesRecord(5, new DateTime(2018, 09, 25), 11000.0, SaleStatus.Billed, s5);
            ...
            SalesRecord r11 = new SalesRecord(11, new DateTime(2018, 09, 25), 11000.0, SaleStatus.Billed, s4);
            ...
            SalesRecord r15 = new SalesRecord(15, new DateTime(2018, 09, 25), 11000.0, SaleStatus.Billed, s4);
            ...
            SalesRecord r23 = new SalesRecord(23, new DateTime(2018, 09, 25), 11000.0, SaleStatus.Billed, s4);
            ...
            SalesRecord r29 = new SalesRecord(29, new DateTime(2018, 09, 25), 11000.0, SaleStatus.Billed, s2);
